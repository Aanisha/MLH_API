...
def opensource():
    open_source = {'1'{'name':'MLH Fellowship','link':'https://fellowship.mlh.io/','desc':'The MLH Fellowship is a 12-week internship alternative for aspiring software engineers. Our programs pair fun, educational curriculum with practical experience that you can put on your resume right away. Its collaborative, remote, and happens under the guidance of expert mentors.'},'2':{'name':'Google Summer of Code','link':'https://summerofcode.withgoogle.com/','desc':'Google Summer of Code is a global program focused on bringing more student developers into open source software development. Students work with an open source organization on a 10 week programming project during their break from school.'},'3':{'name':'Linux Foundation (LFN) Mentorship programme','link':'https://wiki.lfnetworking.org/display/LN/LF+Networking+Wiki','desc':'The LF Networking (LFN) intern/mentorship program is aimed at creating a structured hands-on learning opportunity for new developers who may otherwise lack the opportunity to gain exposure to open source software development and entry to the LFN projects technical communities.'},'4':{'name':'Outreachy','link':'https://www.outreachy.org/','desc':'Outreachy provides remote internships. Outreachy supports diversity in open source and free software!'}}
